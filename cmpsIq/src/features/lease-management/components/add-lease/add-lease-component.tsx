...
import AddPropertyFormik from "@features/property-management/components/AddPropertyFormik";
import { getMetaData, getLeaseDetails, getPropertyDetails } from "./data";
...
const[bdErrorText, setBDErrorText]=useState("");
  ...
  useEffect(() => {
    ...
    if(props.id!=undefined){
      getLeaseDetails(leaDataSetter,props.id)
    ...
    new SimpleReactValidator({
      ...
      validators: {
        ...
        annualRentperSqFtError: {
          ...
          rule: (val: any) => val > 2.0 && val <= 9999999.99,
        },
        freeRentMonthsError: {
          message:
  ...
  const handleClick = (e: React.MouseEventHandler) => {
    let _tempbdError
    if(pageData.leaseExecutionDate == null && pageData.leaseCommencementDate == null )
    {
      setBDError(true)
      _tempbdError=true
      setBDErrorText("Commencement Date and Execution Date both cannot be empty. Please enter any one of them.")
    }
    else{
      setBDError(false)
      _tempbdError=false
  ...
  const setDetails = (details: any) => {
    ...
    _pageData.market = details ? details.market : "";
    _pageData.subMarket = details ? details.subMarket : "";
      ...
      <Container maxWidth="xl" disableGutters>
        <Paper sx={{ mb: 3, p: 3 }}>
          ...
          >
            ...
            id={"Proprty"}
            label={"Property"}
            defaultValue={`${propertyDetails?.address1},${propertyDetails?.address2},${propertyDetails?.state},${propertyDetails.zipCode} | ${propertyDetails?.ownership}`}
            name={"property"}
            gridProps={{
              ...THIRD_WIDTH_GRID_PROPS,
              xs: 2,
          ...
          />}
            ...
            <AddPropertyFormik/>:null}
            {pageData.market != "" && pageData.market != null ? (
              <Grid
                container
              ...
              >
                <Grid item xs={6} sm={4} md={3} lg={2}>
                  <Item>
                    Ownership : <b>{pageData.ownership}</b>
                  </Item>
                </Grid>
                <Grid item xs={6} sm={4} md={3} lg={2}>
                  <Item>
                    Market : <b>{pageData.market}</b>
                  </Item>
                </Grid>
                <Grid item xs={6} sm={4} md={3} lg={2}>
                  <Item>
                    Sub Market : <b>{pageData.subMarket}</b>
                  </Item>
                </Grid>
                <Grid item xs={6} sm={4} md={3} lg={2}>
                  <Item>
                    Total Building Sq Ft : <b>{pageData.totalBuildingSqFt}</b>
                  </Item>
                </Grid>
                <Grid item xs={6} sm={4} md={3} lg={2}>
                  <Item>
                    {" "}
                    Site Coverage : <b>{pageData.siteCoverage}</b>
                  </Item>
                </Grid>
                <Grid item xs={6} sm={4} md={3} lg={2}>
                  <Item>
                    Clear Height : <b>{pageData.clearHeight}</b>
                  </Item>
                </Grid>
                <Grid item xs={6} sm={4} md={3} lg={2}>
                  <Item>
                    {" "}
                    Year Built : <b>{pageData.yearBuilt}</b>
                  </Item>
                </Grid>
              </Grid>
            ) : null}
            ...
            <DropdownCustomWithAGrid
              ...
              gridProps={FORTH_WIDTH_GRID_PROPS}
              label={"Lease Type"}
              defaultValue={pageData.leaseTypeId}
              readOnly={isEdit}
            ...
            <ReadonlyDateandTimePicker
              ...
              //required={true}
              error={!!executionDateError || bdError}
              helperText={executionDateError  || bdErrorText}
            />
            <ReadonlyDateandTimePicker
              ...
              //required={false}
              error={!!commencementDateError || bdError}
              helperText={commencementDateError || bdErrorText}
            />
            <ReadonlyLabelField
              id={"tenant-name"}
              name={"tenant"}
